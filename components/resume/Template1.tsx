...
const HeaderSection: FC<HeaderSectionProps> = (props) => {
    ...
    return (
        <section id="header">
            <h3 className="tracking-[0.2em] font-semibold">{name}</h3>

            <div className="py-3 border-t border-b border-gray-200 mt-6">
                <div className="flex justify-between items-center">
                    <div className="uppercase tracking-widest font-medium">{designation}</div>
                    <a
                        href={'https://' + link}
                        target="_blank"
                        rel="noreferrer"
    ...
    return (
        <section id="contact">
            ...
            <div className="mt-3">
                ...
                <div className="text-gray-700">{contact.linkedIn}</div>
            </div>
        </section>
    );
};
    ...
    return (
        <section id="skills">
            ...
            <div className="mt-3">
                ...
                {/* <ul class="space-y-1 text-gray-700 mt-2 list-disc pl-4">
                    <li>Javascript</li>
                    <li>Java</li>
                    <li>Python</li>
                    <li>PHP</li>
                ...
                <div key={i} className="mt-4">
                    ...
                    {proj.link && (
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-block text-sm text-gray-500 mt-1"
                        >
                            {proj.link}
                        </a>
                    )}
